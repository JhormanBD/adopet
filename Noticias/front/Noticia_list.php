        ...
        <div class="row">
            ...
            <h1><b>Todas las Noticias</b></h1>
                        ...
                        <div class="ibox-tools">
                            ...
                            <button type="button" class="btn btn-primary" onclick="Noticias_insertar()">
                                + Agregar
                            </button>
                           ...
                           <!-- <table class="table table-striped table-bordered table-hover dataTables-example" >-->
                                <thead>
                                    <tr>
                                        ...
                                        <th style=" color:#FFFFFF; background-color: #616161  !important">Titulo</th>
