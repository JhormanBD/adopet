...
$mascota_idMascota=$foto_mascota->getMascota_idMascota()->getIdMascota();
      ...
      try {
          $sql= "INSERT INTO `foto_mascota`( `idfoto_mascota`, `foto_mascota_nombre`, `foto_mascota_ruta`, `Mascota_idMascota`)"
          ."VALUES ('$idfoto_mascota','$foto_mascota_nombre','$foto_mascota_ruta','$mascota_idMascota')";
