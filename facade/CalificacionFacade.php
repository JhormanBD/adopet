...
class CalificacionFacade {
     ...
     * @param calificacion
     */
    public static function insert($fundacion_idFundacion, $usuario_idUsuario, $calificacion) {
    ...
    public static function listAllById($idFundacion) {
        $FactoryDao = new FactoryDao(self::getGestorDefault());
        $calificacionDao = $FactoryDao->getcalificacionDao(self::getDataBaseDefault());
        $result = $calificacionDao->listAllById($idFundacion);
        $calificacionDao->close();
        return $result;
    }
